...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addBranchModel">
    Thêm mới
</button>
        ...
        <div class="modal-content">
            ...
            <form id="addform" action="{{ route('branch.store') }}" method="post">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" onclick="return confirm('Bạn chắc chắn muốn lưu?')">Lưu</button>
