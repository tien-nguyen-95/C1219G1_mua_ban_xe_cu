            ...
            <div class="col-3 pt-3">
                ...
                <nav class="navbar">
                    <ul class="navbar-nav" id="category-list">
                        <li class="nav-item"><a href="" class="nav-link">Loại 1</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Loại 2</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Loại 3</a></li>
                    </ul>
                </nav>
                ...
                <nav class="navbar">
                    <ul class="navbar-nav" id="brand-list">
                        <li class="nav-item"><a href="" class="nav-link">Thương hiệu 1</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Thương hiệu 2</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Thương hiệu 3</a></li>
                    </ul>
                </nav>
                ...
                <nav class="navbar">
                    <ul class="navbar-nav" id="branch-list">
                        <li class="nav-item"><a href="" class="nav-link">Chi nhánh 1</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Chi nhánh 2</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Chi nhánh 3</a></li>
                    </ul>
                </nav>
                <hr>
            </div>
                ...
                <div class="row row-cols-3">
                    @for ($i = 0 ; $i < 10 ; $i++)
                        <div class="col p-1">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Xe không cũ </h4>
                                <h4 class="card-title text-danger">100.000.000 vnd</h4>
                                <p class="card-text">Số km đã đi: Đang cập nhật</p>
                                <a href="{{ route('see-more') }}" class="btn btn-primary">Chi tiết</a>
                            </div>
                        </div>
                        </div>
                    @endfor
